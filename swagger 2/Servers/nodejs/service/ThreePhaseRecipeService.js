 ...
 *
 * recipe ThreePhaselGridBasedSchema A three_phase JSON objectr with a uuid key.
 * returns inline_response_204
 **/
exports.recipeThree_phaseGridbasedPOST = function(recipe) {
 ...
 **/
exports.recipeThree_phaseGridbasedUuidPUT = function(uuid,recipe) {
  return new Promise(function(resolve, reject) {
    resolve();
  });
}
