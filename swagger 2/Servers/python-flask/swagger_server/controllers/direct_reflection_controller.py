...
def recipe_direct_reflection_gridbased_post(recipe):  # noqa: E501
    ...
    Adds a new direct_reflection file to the list # noqa: E501

    :param recipe: A direct_reflection JSON filer with a uuid key.
...
def recipe_direct_reflection_gridbased_uuid_put(uuid, recipe):  # noqa: E501
    ...
    Modifies any parameter (except uuid) of a direct_reflection recipe object by completely replacing the definition file. A finer grain method can be set up later. # noqa: E501
