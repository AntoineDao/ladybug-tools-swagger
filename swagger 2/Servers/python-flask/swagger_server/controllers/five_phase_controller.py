...
def recipe_five_phase_gridbased_post(recipe):  # noqa: E501
    ...
    Adds a new five_phase file to the list # noqa: E501

    :param recipe: A five_phase JSON filer with a uuid key.
...
def recipe_five_phase_gridbased_uuid_put(uuid, recipe):  # noqa: E501
    ...
    Modifies any parameter (except uuid) of a five_phase recipe object by completely replacing the definition file. A finer grain method can be set up later. # noqa: E501
