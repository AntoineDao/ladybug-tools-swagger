...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RadiationGridBasedSchema :  IEquatable<RadiationGridBasedSchema>, IValidatableObject
    {
        /// <summary>
        /// Defines Id
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RadiationGridBasedSchema {\n");
        ...
        {
            return this.Equals(input as RadiationGridBasedSchema);
        }

        /// <summary>
        /// Returns true if RadiationGridBasedSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of RadiationGridBasedSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RadiationGridBasedSchema input)
        {
            if (input == null)
                return false;
