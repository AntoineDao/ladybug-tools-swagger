...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InlineResponse2007Results :  IEquatable<InlineResponse2007Results>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as InlineResponse2007Results);
        }

        /// <summary>
        /// Returns true if InlineResponse2007Results instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2007Results to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2007Results input)
        {
            if (input == null)
                return false;
