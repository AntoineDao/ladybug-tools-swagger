...
namespace IO.Swagger.Model
{
    ...
    public partial class Location :  IEquatable<Location>, IValidatableObject
    {
        ...
        public Location(string City = default(string), decimal? Latitude = default(decimal?), decimal? Longitude = default(decimal?), string TimeZone = default(string), decimal? Elevation = default(decimal?))
        {
            this.City = City;
