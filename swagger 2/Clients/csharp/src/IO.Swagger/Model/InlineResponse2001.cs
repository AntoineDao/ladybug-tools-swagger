...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        /// <param name="AnalysisGrid">AnalysisGrid (required).</param>
        public InlineResponse2001(string Uuid = default(string), AnalysisGridSchema AnalysisGrid = default(AnalysisGridSchema))
        {
            // to ensure "Uuid" is required (not null)
            if (Uuid == null)
            {
                throw new InvalidDataException("Uuid is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
                this.Uuid = Uuid;
            }
            // to ensure "AnalysisGrid" is required (not null)
            if (AnalysisGrid == null)
            {
                throw new InvalidDataException("AnalysisGrid is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
