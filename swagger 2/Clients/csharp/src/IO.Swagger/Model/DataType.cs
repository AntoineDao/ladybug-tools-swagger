...
namespace IO.Swagger.Model
{
    ...
    public partial class DataType :  IEquatable<DataType>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="DataType" /> class.
        /// </summary>
        /// <param name="Standard">Standard (required) (default to null).</param>
        /// <param name="Nickname">Nickname (required) (default to &quot;null&quot;).</param>
        public DataType(StandardEnum Standard = null, string Nickname = "null")
        {
            // to ensure "Standard" is required (not null)
            if (Standard == null)
            {
                throw new InvalidDataException("Standard is a required property for DataType and cannot be null");
            }
            else
            {
            ...
            if (Nickname == null)
            {
                throw new InvalidDataException("Nickname is a required property for DataType and cannot be null");
            }
            else
            {
