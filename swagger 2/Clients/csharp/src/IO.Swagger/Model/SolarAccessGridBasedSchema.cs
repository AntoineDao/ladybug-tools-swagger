...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SolarAccessGridBasedSchema :  IEquatable<SolarAccessGridBasedSchema>, IValidatableObject
    {
        /// <summary>
        /// Defines Id
        /// </summary>
        ...
        public enum IdEnum
        {
            ...
            /// <summary>
            /// Enum Access for value: solar_access
            /// </summary>
            [EnumMember(Value = "solar_access")]
            Access = 1
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SolarAccessGridBasedSchema" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SolarAccessGridBasedSchema {\n");
        ...
        {
            return this.Equals(input as SolarAccessGridBasedSchema);
        }

        /// <summary>
        /// Returns true if SolarAccessGridBasedSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of SolarAccessGridBasedSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolarAccessGridBasedSchema input)
        {
            if (input == null)
                return false;
