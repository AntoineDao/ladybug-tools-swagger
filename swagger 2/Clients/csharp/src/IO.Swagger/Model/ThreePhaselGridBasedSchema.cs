...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ThreePhaselGridBasedSchema :  IEquatable<ThreePhaselGridBasedSchema>, IValidatableObject
    {
        /// <summary>
        /// Defines Id
        /// </summary>
        ...
        public enum IdEnum
        {
            ...
            /// <summary>
            /// Enum Phase for value: three_phase
            /// </summary>
            [EnumMember(Value = "three_phase")]
            Phase = 1
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThreePhaselGridBasedSchema {\n");
        ...
        {
            return this.Equals(input as ThreePhaselGridBasedSchema);
        }

        /// <summary>
        /// Returns true if ThreePhaselGridBasedSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ThreePhaselGridBasedSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThreePhaselGridBasedSchema input)
        {
            if (input == null)
                return false;
