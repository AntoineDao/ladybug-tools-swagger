...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IThreePhaseApi : IApiAccessor
    {
        ...
        /// <param name="recipe">A three_phase JSON filer with a uuid key.</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ThreePhaseApi : IThreePhaseApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ThreePhaseApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ThreePhaseApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ThreePhaseApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Create a new three_phase file Adds a new three_phase file to the list
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="recipe">A three_phase JSON filer with a uuid key.</param>
        /// <returns>InlineResponse204</returns>
        ...
        public ApiResponse< InlineResponse204 > RecipeThreePhaseGridbasedPostWithHttpInfo (ThreePhaselGridBasedSchema recipe)
        {
            ...
            if (recipe == null)
                throw new ApiException(400, "Missing required parameter 'recipe' when calling ThreePhaseApi->RecipeThreePhaseGridbasedPost");
        ...
        /// <summary>
        /// Modify an existing three_phase file Modifies any parameter (except uuid) of a three_phase recipe object by completely replacing the definition file. A finer grain method can be set up later.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="uuid">The unique identifier of the three_phase recipe.</param>
        /// <param name="recipe">A three_phase JSON filer with a uuid key.</param>
        ...
        public ApiResponse<Object> RecipeThreePhaseGridbasedUuidPutWithHttpInfo (string uuid, ThreePhaselGridBasedSchema recipe)
        {
            ...
            if (uuid == null)
                throw new ApiException(400, "Missing required parameter 'uuid' when calling ThreePhaseApi->RecipeThreePhaseGridbasedUuidPut");
            // verify the required parameter 'recipe' is set
            if (recipe == null)
                throw new ApiException(400, "Missing required parameter 'recipe' when calling ThreePhaseApi->RecipeThreePhaseGridbasedUuidPut");
