...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IDaylightFactorApi : IApiAccessor
    {
        ...
        ApiResponse<InlineResponse204> RecipeDaylightFactorGridbasedPostWithHttpInfo (DaylightFactorGridBasedSchema recipe);
        /// <summary>
        ...
        ApiResponse<Object> RecipeDaylightFactorGridbasedUuidPutWithHttpInfo (string uuid, DaylightFactorGridBasedSchema recipe);
        ...
        System.Threading.Tasks.Task<InlineResponse204> RecipeDaylightFactorGridbasedPostAsync (DaylightFactorGridBasedSchema recipe);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse204>> RecipeDaylightFactorGridbasedPostAsyncWithHttpInfo (DaylightFactorGridBasedSchema recipe);
        /// <summary>
        /// Modify an existing analysis_grid file
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task RecipeDaylightFactorGridbasedUuidPutAsync (string uuid, DaylightFactorGridBasedSchema recipe);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> RecipeDaylightFactorGridbasedUuidPutAsyncWithHttpInfo (string uuid, DaylightFactorGridBasedSchema recipe);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DaylightFactorApi : IDaylightFactorApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DaylightFactorApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DaylightFactorApi(String basePath)
        {
        ...
        /// <returns></returns>
        public DaylightFactorApi(Configuration configuration = null)
        {
        ...
        /// <param name="recipe">A analysis_grid JSON filer with a uuid key.</param>
        /// <returns>ApiResponse of InlineResponse204</returns>
        public ApiResponse< InlineResponse204 > RecipeDaylightFactorGridbasedPostWithHttpInfo (DaylightFactorGridBasedSchema recipe)
        {
            // verify the required parameter 'recipe' is set
            if (recipe == null)
                throw new ApiException(400, "Missing required parameter 'recipe' when calling DaylightFactorApi->RecipeDaylightFactorGridbasedPost");

            var localVarPath = "/recipe/daylight_factor/gridbased";
            ...
            {
                Exception exception = ExceptionFactory("RecipeDaylightFactorGridbasedPost", localVarResponse);
        ...
        /// <param name="recipe">A analysis_grid JSON filer with a uuid key.</param>
        /// <returns>Task of ApiResponse (InlineResponse204)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse204>> RecipeDaylightFactorGridbasedPostAsyncWithHttpInfo (DaylightFactorGridBasedSchema recipe)
        {
            // verify the required parameter 'recipe' is set
            if (recipe == null)
                throw new ApiException(400, "Missing required parameter 'recipe' when calling DaylightFactorApi->RecipeDaylightFactorGridbasedPost");
        ...
        /// <summary>
        /// Modify an existing analysis_grid file Modifies any parameter (except uuid) of a daylight_factor recipe object by completely replacing the definition file. A finer grain method can be set up later.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="uuid">The unique identifier of the daylight_factor recipe.</param>
        /// <param name="recipe">A analysis_grid JSON filer with a uuid key.</param>
        ...
        /// <param name="recipe">A analysis_grid JSON filer with a uuid key.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> RecipeDaylightFactorGridbasedUuidPutWithHttpInfo (string uuid, DaylightFactorGridBasedSchema recipe)
        {
            // verify the required parameter 'uuid' is set
            if (uuid == null)
                throw new ApiException(400, "Missing required parameter 'uuid' when calling DaylightFactorApi->RecipeDaylightFactorGridbasedUuidPut");
            // verify the required parameter 'recipe' is set
            if (recipe == null)
                throw new ApiException(400, "Missing required parameter 'recipe' when calling DaylightFactorApi->RecipeDaylightFactorGridbasedUuidPut");
