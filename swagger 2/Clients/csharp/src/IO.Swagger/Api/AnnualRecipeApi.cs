...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IAnnualRecipeApi : IApiAccessor
    {
        ...
        /// <param name="recipe">A annual JSON objectr with a uuid key.</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AnnualRecipeApi : IAnnualRecipeApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AnnualRecipeApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AnnualRecipeApi(String basePath)
        {
        ...
        /// <returns></returns>
        public AnnualRecipeApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Create a new annual object Adds a new annual object to the list
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="recipe">A annual JSON objectr with a uuid key.</param>
        /// <returns>InlineResponse204</returns>
        ...
        public ApiResponse< InlineResponse204 > RecipeAnnualGridbasedPostWithHttpInfo (AnnualGridBasedSchema recipe)
        {
            ...
            if (recipe == null)
                throw new ApiException(400, "Missing required parameter 'recipe' when calling AnnualRecipeApi->RecipeAnnualGridbasedPost");
        ...
        /// <summary>
        /// Modify an existing annual object Modifies any parameter (except uuid) of a annual recipe object by completely replacing the definition object. A finer grain method can be set up later.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="uuid">The unique identifier of the annual recipe.</param>
        /// <param name="recipe">A annual JSON objectr with a uuid key.</param>
        ...
        public ApiResponse<Object> RecipeAnnualGridbasedUuidPutWithHttpInfo (string uuid, AnnualGridBasedSchema recipe)
        {
            ...
            if (uuid == null)
                throw new ApiException(400, "Missing required parameter 'uuid' when calling AnnualRecipeApi->RecipeAnnualGridbasedUuidPut");
            // verify the required parameter 'recipe' is set
            if (recipe == null)
                throw new ApiException(400, "Missing required parameter 'recipe' when calling AnnualRecipeApi->RecipeAnnualGridbasedUuidPut");
