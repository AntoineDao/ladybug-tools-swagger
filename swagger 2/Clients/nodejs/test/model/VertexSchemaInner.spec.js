...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HoneybeeServerApi.VertexSchemaInner();
  });
  ...
  describe('VertexSchemaInner', function() {
    it('should create an instance of VertexSchemaInner', function() {
      // uncomment below and update the code to test VertexSchemaInner
      //var instane = new HoneybeeServerApi.VertexSchemaInner();
      //expect(instance).to.be.a(HoneybeeServerApi.VertexSchemaInner);
    });
