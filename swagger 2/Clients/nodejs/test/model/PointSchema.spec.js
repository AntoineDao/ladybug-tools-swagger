...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HoneybeeServerApi.PointSchema();
  });
  ...
  describe('PointSchema', function() {
    it('should create an instance of PointSchema', function() {
      // uncomment below and update the code to test PointSchema
      //var instane = new HoneybeeServerApi.PointSchema();
      //expect(instance).to.be.a(HoneybeeServerApi.PointSchema);
    });
