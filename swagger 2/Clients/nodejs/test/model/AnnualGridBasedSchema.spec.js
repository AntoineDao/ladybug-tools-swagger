...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HoneybeeServerApi.AnnualGridBasedSchema();
  });
  ...
  describe('AnnualGridBasedSchema', function() {
    it('should create an instance of AnnualGridBasedSchema', function() {
      // uncomment below and update the code to test AnnualGridBasedSchema
      //var instane = new HoneybeeServerApi.AnnualGridBasedSchema();
      //expect(instance).to.be.a(HoneybeeServerApi.AnnualGridBasedSchema);
    });
