...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HoneybeeServerApi.SurfacePropertySchema();
  });
  ...
  describe('SurfacePropertySchema', function() {
    it('should create an instance of SurfacePropertySchema', function() {
      // uncomment below and update the code to test SurfacePropertySchema
      //var instane = new HoneybeeServerApi.SurfacePropertySchema();
      //expect(instance).to.be.a(HoneybeeServerApi.SurfacePropertySchema);
    });
