...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HoneybeeServerApi.VectorSchema();
  });
  ...
  describe('VectorSchema', function() {
    it('should create an instance of VectorSchema', function() {
      // uncomment below and update the code to test VectorSchema
      //var instane = new HoneybeeServerApi.VectorSchema();
      //expect(instance).to.be.a(HoneybeeServerApi.VectorSchema);
    });
