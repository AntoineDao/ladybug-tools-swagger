...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HoneybeeServerApi.FivePhaselGridBasedSchema = factory(root.HoneybeeServerApi.ApiClient, root.HoneybeeServerApi.AnalysisGridSchema, root.HoneybeeServerApi.AnalysisType, root.HoneybeeServerApi.HBSurfaceSchema, root.HoneybeeServerApi.RadianceParameters, root.HoneybeeServerApi.SkyMtxSchema);
  }
  ...
  /**
   * The FivePhaselGridBasedSchema model module.
   * @module model/FivePhaselGridBasedSchema
   * @version 0.0.0
   */

  /**
   * Constructs a new <code>FivePhaselGridBasedSchema</code>.
   * @alias module:model/FivePhaselGridBasedSchema
   * @class
   */
  ...
  /**
   * Constructs a <code>FivePhaselGridBasedSchema</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FivePhaselGridBasedSchema} obj Optional instance to populate.
   * @return {module:model/FivePhaselGridBasedSchema} The populated <code>FivePhaselGridBasedSchema</code> instance.
   */
  ...
  /**
   * @member {module:model/FivePhaselGridBasedSchema.IdEnum} id
   */
  exports.prototype['id'] = undefined;
  /**
   * @member {module:model/FivePhaselGridBasedSchema.TypeEnum} type
   */
