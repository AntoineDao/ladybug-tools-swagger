...
class PointInTimeRecipeApi(object):
    ...
    def recipe_point_in_time_gridbased_post(self, recipe, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param PointInTimeGridBasedSchema recipe: A point_in_time JSON objectr with a uuid key. (required)
    ...
    def recipe_point_in_time_gridbased_uuid_put(self, uuid, recipe, **kwargs):  # noqa: E501
        ...
        :param PointInTimeGridBasedSchema recipe: A analysis_grid JSON objectr with a uuid key. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
